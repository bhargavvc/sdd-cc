...
/**
 * Deterministic verifier for the /sdd-reapply-patches Step 5 "Hunk Verification
 ...
 *     --patches-dir <path>        \  # sdd-local-patches/
 *     --config-dir <path>         \  # ~/.claude (or runtime equivalent)
 *     [--pristine-dir <path>]        # sdd-pristine/; if absent, falls back to
