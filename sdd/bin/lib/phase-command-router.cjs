...
function routePhaseCommand({ phase, args, cwd, raw, error }) {
  routeCjsCommandFamily({
    ...
    unsupported: {
      'list-plans': 'phase list-plans is SDK-only. Use: sdd-sdk query phase.list-plans ...',
      'list-artifacts': 'phase list-artifacts is SDK-only. Use: sdd-sdk query phase.list-artifacts ...',
