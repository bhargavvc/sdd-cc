/**
 * Canonical SDD artifact registry.
 *
 * Enumerates the file names that sdd workflows officially produce at the
 * .planning/ root level. Used by sdd-health (W019) to flag unrecognized files
...
const CANONICAL_PATTERNS = [
  /^v\d+\.\d+(?:\.\d+)?-MILESTONE-AUDIT\.md$/i,  // sdd-complete-milestone (pre-archive)
