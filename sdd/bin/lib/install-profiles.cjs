 ...
 *
 * Background: every installed `sdd-*` skill costs eager system-prompt
 ...
 *
 * The `minimal` profile installs the main SDD loop only:
...
/**
 * Stage a filtered copy of the source commands/sdd directory when in
