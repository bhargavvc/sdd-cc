 ...
 * Keeps sdd-tools.cjs thin while preserving existing command semantics.
 */
function routeStateCommand({ state, args, cwd, raw, parseNamedArgs, error }) {
  ...
  routeCjsCommandFamily({
    ...
    unsupported: {
      'add-roadmap-evolution': 'state add-roadmap-evolution is SDK-only. Use: sdd-sdk query state.add-roadmap-evolution ...',
    },
    error,
