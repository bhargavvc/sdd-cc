...
For deep ecosystem research ("how do experts build this"), use `/sdd-plan-phase --research-phase` which produces RESEARCH.md.
...
- Use `/sdd-plan-phase --research-phase` for these
</guidelines>
