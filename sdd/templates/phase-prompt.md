...
<!-- For checkpoint task examples and patterns, see @~/.claude/sdd/references/checkpoints.md -->
...
See `~/.claude/sdd/references/tdd.md` for TDD plan structure.
...
See `~/.claude/sdd/templates/user-setup.md` for full schema and examples
...
See `~/.claude/sdd/workflows/verify-phase.md` for verification logic.
