...
- `intel.enabled` — enable queryable codebase intelligence (/sdd-intel) (default: false if absent)
...
AskUserQuestion([
  ...
  {
    question: "Enable Intel? (queryable codebase intelligence via /sdd-intel — builds a JSON index in .planning/intel/)",
    header: "Intel",
    multiSelect: false,
    options: [
      { label: "No (Recommended)", description: "Skip intel indexing. Use when codebase is small or intel queries are not needed." },
      { label: "Yes", description: "Enable /sdd-intel commands. Builds and queries a JSON index of the codebase." }
    ]
  },
  {
