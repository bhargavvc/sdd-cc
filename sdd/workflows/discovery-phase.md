...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /sdd:plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/sdd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/sdd/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/sdd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/sdd/templates/discovery.md
...
Use ~/.claude/sdd/templates/discovery.md.
