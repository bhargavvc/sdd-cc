...
```bash
INIT=$(node "$HOME/.claude/sdd/bin/sdd-tools.cjs" init new-milestone)
...
**Commit requirements:**
```bash
node "$HOME/.claude/sdd/bin/sdd-tools.cjs" commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "$HOME/.claude/sdd/bin/sdd-tools.cjs" commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
