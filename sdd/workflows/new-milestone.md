...
```bash
sdd-sdk query commit "docs: start milestone v[X.Y] [Name]" .planning/PROJECT.md .planning/STATE.md
```
...
**Commit requirements:**
```bash
sdd-sdk query commit "docs: define milestone v[X.Y] requirements" .planning/REQUIREMENTS.md
```
...
```bash
sdd-sdk query commit "docs: create milestone v[X.Y] roadmap ([N] phases)" .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
