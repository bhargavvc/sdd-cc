...
AGENT_SKILLS_UI_REVIEWER=$(sdd-sdk query agent-skills sdd-ui-auditor)
```
...
```markdown
Read ~/.claude/agents/sdd-ui-auditor.md for instructions.
...
```bash
sdd-sdk query commit "docs(${padded_phase}): UI audit review" --files "${PHASE_DIR}/${PADDED_PHASE}-UI-REVIEW.md"
```
