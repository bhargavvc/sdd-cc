...
```bash
AGENT_SKILLS_DEBUGGER=$(sdd-sdk query agent-skills sdd-debugger)
...
```bash
sdd-sdk query commit "docs({phase_num}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase_num}-UAT.md"
```
</step>
