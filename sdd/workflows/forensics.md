...
Post-mortem investigation for failed or stuck SDD workflows. Analyzes git history,
...
BUG_LABEL=$(gh label list --repo bhargavvc/sdd-cc --search "bug" --json name -q '.[0].name' 2>/dev/null)
LABEL_FLAG=""
if [ -n "$BUG_LABEL" ]; then
