<purpose>
Retroactive audit of an implemented AI phase's evaluation coverage. Standalone command that works on any SDD-managed AI phase. Produces a scored EVAL-REVIEW.md with gap analysis and remediation plan.

Use after /sdd-execute-phase to verify that the evaluation strategy from AI-SPEC.md was actually implemented. Mirrors the pattern of /sdd-ui-review and /sdd-validate-phase.
</purpose>
...
```bash
AUDITOR_MODEL=$(sdd-sdk query resolve-model sdd-eval-auditor 2>/dev/null | jq -r '.model' 2>/dev/null || true)
```

Display banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 SDD ► EVAL AUDIT — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**State C** — No SUMMARY.md: Exit — "Phase {N} not executed. Run /sdd-execute-phase {N} first."
...
Consider running /sdd-ai-integration-phase {N} before implementation next time.
```
...
```markdown
Read ~/.claude/agents/sdd-eval-auditor.md for instructions.
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 SDD ► EVAL AUDIT COMPLETE — PHASE {N}: {name}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
{If PRODUCTION READY:}
  Next step: /sdd-plan-phase (next phase) or deploy

{If NEEDS WORK:}
  Address critical gaps in EVAL-REVIEW.md, then re-run /sdd-eval-review {N}
...
- [ ] sdd-eval-auditor spawned with correct context
