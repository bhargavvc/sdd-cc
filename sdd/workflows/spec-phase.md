...
If "Skip": Exit with message: "Existing SPEC.md unchanged. Run /sdd-discuss-phase [X] to continue."
...
Use the SPEC.md template from @~/.claude/sdd/templates/spec.md.
...
- User directed to /sdd-discuss-phase as next step
</success_criteria>
