...
Examples:
  `/sdd-edit-phase 5`       → phase = 5, force = false
  `/sdd-edit-phase 5 --force` → phase = 5, force = true
  `/sdd-edit-phase 12.1`    → phase = 12.1, force = false

If no argument provided:

```
ERROR: Phase number required
Usage: /sdd-edit-phase <phase-number> [--force]
Example: /sdd-edit-phase 5
Example: /sdd-edit-phase 5 --force
```
...
```bash
PHASE_DATA=$(sdd-sdk query roadmap get-phase "${target}")
```
...
```bash
ALL_PHASES=$(sdd-sdk query roadmap analyze)
```
