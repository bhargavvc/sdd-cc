...
**`/sdd-plan-phase <number> [--research] [--skip-research] [--research-phase <N>] [--view] [--gaps] [--skip-verify] [--tdd] [--mvp]`**
...
- **`/sdd-review`** — Quality-gate routing (code review, debug, audit, security, eval, ui).
