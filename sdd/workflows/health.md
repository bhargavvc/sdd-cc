...
```bash
sdd-sdk query validate.context \
...
```bash
sdd-sdk query validate.health $REPAIR_FLAG $BACKFILL_FLAG
```
...
| W019 | warning | Unrecognized .planning/ root file — not a canonical SDD artifact | No |
