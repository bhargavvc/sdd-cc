...
- `tests/bug-3359-stale-sdd-sdk-path-version.test.cjs`
...
- Q4 (installer-only vs shared seam): **resolved — shared.** The seam lives in `sdd/bin/lib/`, consumed by installer, planning workflow, and every fs/subprocess call site across the tool.
