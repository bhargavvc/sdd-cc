...
This directory contains Architecture Decision Records (ADRs) for SDD.
...
| [0007-sdk-package-seam-module.md](0007-sdk-package-seam-module.md) | SDK Package Seam Module owns SDK-to-@bhargavvc/sdd-cc compatibility | Accepted |
...
| [0011-review-default-reviewers.md](0011-review-default-reviewers.md) | Review default-reviewers selection policy for /sdd:review | Accepted |
...
profile staging (`--profile=<name>`, `.sdd-profile` marker, `requires:` closure)
and the Phase 2 runtime `/sdd:surface` command for cluster-level enable/disable
without reinstall.
