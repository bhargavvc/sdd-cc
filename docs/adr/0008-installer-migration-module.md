...
The registry records what SDD installs, where it installs it, when migrations
...
- The installer can remove stale SDD-owned artifacts without guessing about user files.
