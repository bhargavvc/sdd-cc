...
**Command:** `/sdd-review --phase N [--gemini] [--claude] [--codex] [--coderabbit] [--opencode] [--qwen] [--cursor] [--all]`
...
**Command:** `/sdd-intel [query <term>|status|diff|refresh]`
...
**Command:** `/sdd-scan [--focus tech|arch|quality|concerns|tech+arch]`

**Purpose:** Lightweight alternative to `/sdd-map-codebase` that spawns a single mapper agent for a specific focus area, producing targeted output in `.planning/codebase/` without the overhead of 4 parallel agents.
...
**Command:** `/sdd-from-gsd2 [--dry-run] [--force] [--path <dir>]`
