...
Comprehensive documentation for the Spec-Driven Development (SDD) framework — a meta-prompting, context engineering, and spec-driven development system for AI coding agents.
...
| [Custom PR Body Sections](ship-pr-body-sections.md) | All users | How to append project-specific PRD sections to `/sdd-ship` PR bodies |
| [CLI Tools Reference](CLI-TOOLS.md) | Contributors, agent authors | `sdd-tools.cjs` programmatic API for workflows and agents |
| [JSON Error Mode](json-errors.md) | Contributors, agent authors | Machine-readable `sdd-tools --json-errors` failure envelopes |
...
- **Configuring SDD:** [Configuration Reference](CONFIGURATION.md)
