 ...
 *
 * Walks workflowsDir, extracts every `${SDD_HOME[...]}/<path>.<cjs|js|sh>`
 * token, and asserts:
...
// Match `${SDD_HOME}` or `${SDD_HOME:-...}` followed by a /-rooted path
// ending in .cjs/.js/.sh. The path is captured verbatim (relative to
// the install root).
const REF_RE = /\$\{SDD_HOME(?::-[^}]*)?\}\/([A-Za-z0-9_./-]+\.(?:cjs|js|sh))/g;
