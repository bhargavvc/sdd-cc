...
const FIXED_GROUPS = [
  ...
  },
  {
    ...
    pattern: /\b(install|installer|runtime|windows|powershell|codex|gemini|antigravity|hook|hooks|sdd-sdk|sdk readiness|cjs|model-catalog|path|shim)\b/i,
  },
];
...
const REMOVED_GROUPS = [
  {
    title: 'Intel updater',
    pattern: /\b(intel|sdd-intel-updater|layout detection)\b/i,
  },
];
