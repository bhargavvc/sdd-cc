...
**Process:**
1. Open a [Bug Report issue](https://github.com/gsd-build/sdd/issues/new?template=bug_report.yml) — fill it out completely.
...
**Process:**
1. Open an [Enhancement issue](https://github.com/gsd-build/sdd/issues/new?template=enhancement.yml) with the full proposal.  The issue template requires: the problem being solved, the concrete benefit, the scope of changes, and alternatives considered.
...
**Process:**
1. **Discuss first** — check [Discussions](https://github.com/gsd-build/sdd/discussions) to see if the idea has been raised. If it has and was declined, don't open a new issue.
2. Open a [Feature Request issue](https://github.com/gsd-build/sdd/issues/new?template=feature_request.yml) with the complete spec. The template requires: the solo-developer problem being solved, what is being added, full scope of affected files and systems, user stories, acceptance criteria, and assessment of maintenance burden.
