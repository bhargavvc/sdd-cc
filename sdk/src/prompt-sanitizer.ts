 ...
 * patterns from SDD-1 prompts so they're safe for headless SDK use.
 *
 * @-file references (e.g., @~/.claude/sdd/references/foo.md) are
 ...
 * - /sdd-... skill commands (can't invoke skills in Agent SDK)
 ...
 * - @~/.claude/sdd/references/foo.md
 * - @~/.claude/sdd/workflows/bar.md
