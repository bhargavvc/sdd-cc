/**
 * Bug #3591: createSDDToolsRuntime accepts a `workstream` option, but the
 ...
 * `.planning/workstreams/<name>` whenever a SDDTools instance was created
...
describe('bug #3591: createSDDToolsRuntime forwards workstream to registry.dispatch', () => {
