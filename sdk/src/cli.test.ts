...
describe('parseCliArgs', () => {
  ...
  it('parses query permissively (keeps sdd-tools flags like --pick, --json)', () => {
    const result = parseCliArgs([
  ...
  it('forwards --help to queryArgv when a subcommand precedes it (#3019)', () => {
    ...
    // (or the sdd-tools.cjs fallback) can render contextual subcommand help.
  ...
  it('preserves --help position when intermixed with other query flags (#3019)', () => {
    // sdd-sdk query phase --help --pick name
