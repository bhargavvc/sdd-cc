...
import type { ParsedPlan, PlanResult, SessionOptions, SessionUsage, SDDCostUpdateEvent, PhaseStepType } from './types.js';
import { SDDEventType, PhaseType } from './types.js';
...
import type { SDDEventStream, EventStreamContext } from './event-stream.js';
 ...
 */
function resolveModel(options?: SessionOptions, config?: SDDConfig): string | undefined {
  ...
  // Use `detectRuntime` so `SDD_RUNTIME` env precedence is honored — a Codex
 ...
 * @param config - SDD project configuration
