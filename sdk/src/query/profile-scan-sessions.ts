/**
 * Session scan — parity with `sdd/bin/lib/profile-pipeline.cjs` `cmdScanSessions`.
 * Used by `scanSessions` query handler so SDK JSON matches `sdd-tools.cjs scan-sessions --json`.
 */
