...
describe('command seam coverage (manifest -> generated -> adapters)', () => {
  ...
  it('CJS seam adapters export expected router functions', () => {
    ...
    const stateRouter = require('../../../sdd/bin/lib/state-command-router.cjs');
    const verifyRouter = require('../../../sdd/bin/lib/verify-command-router.cjs');
    const initRouter = require('../../../sdd/bin/lib/init-command-router.cjs');
    const phaseRouter = require('../../../sdd/bin/lib/phase-command-router.cjs');
    const phasesRouter = require('../../../sdd/bin/lib/phases-command-router.cjs');
    const validateRouter = require('../../../sdd/bin/lib/validate-command-router.cjs');
    const roadmapRouter = require('../../../sdd/bin/lib/roadmap-command-router.cjs');
