/**
 * Open Artifact Audit — full TypeScript port of `sdd/bin/lib/audit.cjs`.
 *
 * Scans `.planning/` artifact categories for unresolved items (same JSON as sdd-tools `audit-open`).
 */
...
/**
 * Same structured result as `sdd-tools.cjs audit-open` (JSON).
 */
...
/**
 * Human-readable report (same text as sdd-tools without `--json`).
 */
