...
export const stateRecordMetric: QueryHandler = async (args, projectDir) => {
  ...
  if (!phase || !plan || !duration) {
    throw new SDDError('phase, plan, and duration required', ErrorClassification.Validation);
  }
...
export const stateAddDecision: QueryHandler = async (args, projectDir) => {
  ...
  if (!decisionText) {
    throw new SDDError('decision text required', ErrorClassification.Validation);
  }
...
export const stateAddBlocker: QueryHandler = async (args, projectDir) => {
  ...
  if (!blockerText) {
    throw new SDDError('blocker text required', ErrorClassification.Validation);
  }
...
export const stateResolveBlocker: QueryHandler = async (args, projectDir) => {
  ...
  if (!searchText) {
    throw new SDDError('search text required', ErrorClassification.Validation);
  }
