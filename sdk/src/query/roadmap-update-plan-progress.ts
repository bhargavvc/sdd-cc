 ...
 *
 * Port of `cmdRoadmapUpdatePlanProgress` from sdd/bin/lib/roadmap.cjs
...
export const roadmapUpdatePlanProgress: QueryHandler = async (args, projectDir, workstream) => {
  ...
  if (!phaseNum) {
    throw new SDDError('phase number required for roadmap update-plan-progress', ErrorClassification.Validation);
  }
