 ...
 * `sdd/bin/lib/init.cjs` (lines 1640–1847).
...
/**
 * Scan canonical skill roots and build manifest JSON (same shape as sdd-tools.cjs).
 */
  ...
  const canonicalRoots = skillsDir
    ...
    : [
      ...
      },
      {
        ...
        path: join(homedir(), '.claude', 'commands', 'sdd'),
...
/**
 * `skill-manifest` — same flags as sdd-tools: `--skills-dir`, `--write`.
 */
