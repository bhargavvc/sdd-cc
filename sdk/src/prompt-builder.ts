...
/**
 * Extract the tools list from a sdd-executor.md agent definition.
...
/**
 * Extract the role instructions from a sdd-executor.md agent definition.
 ...
 * @param agentDef - Raw content of sdd-executor.md agent definition (optional)
