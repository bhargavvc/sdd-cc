/**
 * Read-only subprocess golden rows: SDK `registry.dispatch` vs `sdd-tools.cjs` JSON on stdout.
...
/** Repo-relative fixtures (cwd = sdd repo root). */
 ...
 * (Expand as more handlers are aligned with `sdd-tools.cjs`.)
 */
export const READ_ONLY_JSON_PARITY_ROWS: JsonParityRow[] = [
  { canonical: 'resolve-model', sdkArgs: ['sdd-planner'], cjs: 'resolve-model', cjsArgs: ['sdd-planner'] },
  ...
  { canonical: 'intel.query', sdkArgs: ['sdd'], cjs: 'intel', cjsArgs: ['query', 'sdd'] },
  {
