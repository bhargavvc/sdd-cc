...
import type { SDDLogger } from './logger.js';
...
export class PhaseRunner {
  ...
  private readonly logger?: SDDLogger;
   ...
   * Loads the sdd-plan-checker agent definition, runs a Verify-scoped session,
  ...
  private async runExecuteStep(
    ...
    // Get the plan index from sdd-tools
