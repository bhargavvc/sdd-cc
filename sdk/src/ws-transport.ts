/**
 * WebSocket Transport — broadcasts SDD events as JSON over WebSocket.
 *
...
import type { SDDEvent, TransportHandler } from './types.js';
...
export class WSTransport implements TransportHandler {
  ...
  /**
   * Broadcast a SDD event as JSON to all connected clients.
