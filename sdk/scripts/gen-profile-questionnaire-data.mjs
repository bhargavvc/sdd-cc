...
const cjs = fs.readFileSync(join(root, 'sdd/bin/lib/profile-output.cjs'), 'utf-8');
...
const header = `/**
 * Synced from sdd/bin/lib/profile-output.cjs (PROFILING_QUESTIONS, CLAUDE_INSTRUCTIONS).
