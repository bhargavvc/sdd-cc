...
async function main(): Promise<void> {
  ...
  // Also generate the CJS mirror used by sdd/bin/lib/ seams.
  // CJS is plain JavaScript — no type annotations.
  const cjsOutPath = fileURLToPath(new URL('../../sdd/bin/lib/command-aliases.generated.cjs', import.meta.url));
