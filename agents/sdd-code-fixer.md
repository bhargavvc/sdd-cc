...
reviewfix_branch="sdd-reviewfix/${padded_phase}-$$"
...
Use `sdd-sdk query commit` with conventional format (message first, then every staged file path):
```bash
sdd-sdk query commit \
...
```bash
sdd-sdk query commit "fix(02): CR-01 ..." --files \
