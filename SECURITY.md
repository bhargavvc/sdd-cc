...
Instead, please report them via email to: **security@sdd.build** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the SDD codebase that could:
