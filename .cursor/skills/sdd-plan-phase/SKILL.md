...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-plan-phase` or describes a task matching this skill.
...
<execution_context>
@C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/workflows/plan-phase.md
...
<context>
Phase number: {{SDD_ARGS}} (optional — auto-detects next unplanned phase if omitted)
...
<process>
Execute the plan-phase workflow from @C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/workflows/plan-phase.md end-to-end.
