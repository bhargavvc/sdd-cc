...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-debug` or describes a task matching this skill.
...
```bash
debugger_model=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" resolve-model sdd-debugger --raw)
```
...
If {{SDD_ARGS}} provided OR user describes new issue:
...
- [ ] sdd-debugger spawned with context
