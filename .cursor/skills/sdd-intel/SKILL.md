...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-intel` or describes a task matching this skill.
...
Intel system is disabled. To activate:
  ...
  node C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs config-set intel.enabled true
...
Parse `{{SDD_ARGS}}` to determine the operation mode:
...
```bash
node C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs intel query <term>
```
...
```bash
node C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs intel status
```
...
```bash
node C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs intel diff
```
...
Project root: ${CWD}
sdd-tools path: C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs
