...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-forensics` or describes a task matching this skill.
...
<execution_context>
@C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/workflows/forensics.md
</execution_context>
...
**User input:**
- Problem description: {{SDD_ARGS}} (optional — will ask if not provided)
</context>

<process>
Read and execute the forensics workflow from @C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/workflows/forensics.md end-to-end.
</process>
