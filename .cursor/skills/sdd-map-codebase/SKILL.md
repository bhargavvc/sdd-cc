...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-map-codebase` or describes a task matching this skill.
...
<execution_context>
@C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/workflows/map-codebase.md
</execution_context>

<context>
Focus area: {{SDD_ARGS}} (optional - if provided, tells agents to focus on specific subsystem)
