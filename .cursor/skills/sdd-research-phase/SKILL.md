...
## A. Skill Invocation
- This skill is invoked when the user mentions `sdd-research-phase` or describes a task matching this skill.
...
```bash
INIT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" init phase-op "{{SDD_ARGS}}")
...
```bash
RESEARCHER_MODEL=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" resolve-model sdd-phase-researcher --raw)
```

## 1. Validate Phase

```bash
PHASE_INFO=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" roadmap get-phase "${phase_number}")
```
