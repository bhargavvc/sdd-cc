...
```bash
INIT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" init phase-op "0")
...
<step name="add_phase">
**Delegate the phase addition to sdd-tools:**

```bash
RESULT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" phase add "${description}")
```
...
<success_criteria>
- [ ] `sdd-tools phase add` executed successfully
