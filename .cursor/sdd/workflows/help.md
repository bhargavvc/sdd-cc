...
**SDD** (Spec-Driven Development) creates hierarchical project plans optimized for solo agentic development with Cursor.
...
- Saves timestamped note to `.planning/notes/` (or `C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/notes/` globally)
...
**`/sdd-review --phase N [--gemini] [--claude] [--codex] [--coderabbit] [--all]`**
