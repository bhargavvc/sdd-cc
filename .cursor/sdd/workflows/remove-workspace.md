<purpose>
Remove a SDD workspace, cleaning up git worktrees and deleting the workspace directory.
</purpose>
...
Extract workspace name from {{SDD_ARGS}}.

```bash
INIT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" init remove-workspace "$WORKSPACE_NAME")
