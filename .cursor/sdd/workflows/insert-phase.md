...
```bash
INIT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" init phase-op "${after_phase}")
...
**Delegate the phase insertion to sdd-tools:**

```bash
RESULT=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" phase insert "${after_phase}" "${description}")
```
...
- [ ] `sdd-tools phase insert` executed successfully
