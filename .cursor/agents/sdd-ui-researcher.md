...
|----------|----------------|
| `sdd-ui-checker` | Validates against 6 design quality dimensions |
| `sdd-planner` | Uses design tokens, component inventory, and copywriting in plan tasks |
| `sdd-executor` | References as visual source of truth during implementation |
| `sdd-ui-auditor` | Compares implemented UI against the contract retroactively |
...
Use template from `C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/templates/UI-SPEC.md`.
...
Read template: `C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/templates/UI-SPEC.md`
...
```bash
node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
