...
**The difference:**
- `sdd-verifier`: Verifies code DID achieve goal (after execution)
- `sdd-plan-checker`: Verifies plans WILL achieve goal (before execution)
...
@C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/references/thinking-models-planning.md

For calibration on scoring and issue identification, reference these examples:
@C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/references/few-shot-examples/plan-checker.md
...
Use sdd-tools to validate plan structure:

```bash
for plan in "$PHASE_DIR"/*-PLAN.md; do
  echo "=== $plan ==="
  PLAN_STRUCTURE=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" verify plan-structure "$plan")
  echo "$PLAN_STRUCTURE"
done
```
...
Extract must_haves from each plan using sdd-tools:

```bash
MUST_HAVES=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" frontmatter get "$PLAN_PATH" --field must_haves)
```
...
Use sdd-tools plan-structure verification (already run in Step 2):

```bash
PLAN_STRUCTURE=$(node "C:/Users/DS_Chitteti Bhargav/OneDrive - Data Semantics Pvt Ltd/Work/SDD-Setup/sdd-cc/.cursor/sdd/bin/sdd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
**For manual validation of specificity** (sdd-tools checks structure, not content quality):
```bash
...
**DO NOT** check code existence — that's sdd-verifier's job. You verify plans, not codebase.
