...
const SH_HOOKS = [
  { name: 'sdd-validate-commit.sh', settingsVar: 'validateCommitCommand' },
  { name: 'sdd-session-state.sh',   settingsVar: 'sessionStateCommand' },
  { name: 'sdd-phase-boundary.sh',  settingsVar: 'phaseBoundaryCommand' },
];
