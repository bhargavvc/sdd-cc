...
describe('new consolidated skills exist', () => {
  test('commands/sdd/capture.md exists', () => {
  ...
  test('commands/sdd/phase.md exists', () => {
  ...
  test('commands/sdd/config.md exists', () => {
  ...
  test('commands/sdd/workspace.md exists', () => {
...
describe('absorbed skills are removed', () => {
  ...
  for (const [name, reason] of absorbed) {
    test(`commands/sdd/${name}.md does NOT exist (${reason})`, () => {
      assert.ok(
...
describe('outright deleted dead skills are removed', () => {
  ...
  for (const name of deleted) {
    test(`commands/sdd/${name}.md does NOT exist`, () => {
      assert.ok(
        !fs.existsSync(skillPath(name)),
...
describe('settings.md is kept (merged into config entry point or remains standalone)', () => {
  test('commands/sdd/settings.md still exists', () => {
    assert.ok(
...
describe('skill count', () => {
  test('total user-invocable files in commands/sdd/*.md is <= 63', () => {
