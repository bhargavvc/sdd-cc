...
describe('phases list command', () => {
  ...
  test('empty phases directory returns empty array', () => {
    const result = runSddTools('phases list', tmpDir);
  ...
  test('--type plans lists only PLAN.md files', () => {
    ...
    const result = runSddTools('phases list --type plans', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--type summaries lists only SUMMARY.md files', () => {
    ...
    const result = runSddTools('phases list --type summaries', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('--phase filters to specific phase directory', () => {
    ...
    const result = runSddTools('phases list --type plans --phase 01', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase next-decimal command', () => {
  ...
  test('returns X.1 when no decimal phases exist', () => {
    ...
    const result = runSddTools('phase next-decimal 06', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles single-digit phase input', () => {
    ...
    const result = runSddTools('phase next-decimal 6', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
  ...
  test('phase not found returns error', () => {
    const result = runSddTools('phase-plan-index 99', tmpDir);
    assert.ok(result.success, `Command should succeed: ${result.error}`);
...
`
    ...
    const result = runSddTools('phase-plan-index 04', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
<execution_context>
@~/.claude/sdd/workflows/execute-plan.md
</execution_context>
...
`
    ...
    const result = runSddTools('phase add User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('handles empty roadmap', () => {
    ...
    const result = runSddTools('phase add Initial Setup', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('phase add ignores --raw instead of persisting it in the description', () => {
    ...
    const result = runSddTools(['phase', 'add', '--raw', 'User', 'Dashboard'], tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('phase add rejects unsupported flags and dangling --id', () => {
    ...
    const unsupported = runSddTools(['phase', 'add', '--unknown', 'Dashboard'], tmpDir);
    ...
    const dangling = runSddTools(['phase', 'add', 'Dashboard', '--id'], tmpDir);
...
`
    ...
    const result = runSddTools('phase add Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase add — orphan directory collision prevention (#2026)', () => {
  ...
  test('orphan directories with 999.x prefix are skipped when calculating disk max', () => {
    ...
    const result = runSddTools('phase add new-feature', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('project_code prefix in orphan directory name is stripped before comparing', () => {
    ...
    const result = runSddTools('phase add new-feature', tmpDir, { HOME: tmpDir });
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase add with project_code', () => {
  ...
  test('prefixes phase directory with project_code', () => {
    ...
    const result = runSddTools('phase add User Dashboard', tmpDir, { HOME: tmpDir });
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('find-phase resolves prefixed directories', () => {
    ...
    const result = runSddTools('find-phase 01', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase add-batch command (#2165)', () => {
  ...
  test('adds multiple phases with sequential numbers in a single call', () => {
    ...
    const result = runSddTools(['phase', 'add-batch', '--descriptions', '["Alpha","Beta","Gamma"]'], tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('no duplicate phase numbers when multiple add-batch calls are made sequentially', () => {
    ...
    const r1 = runSddTools(['phase', 'add-batch', '--descriptions', '["Wave-One-A","Wave-One-B"]'], tmpDir);
    assert.ok(r1.success, `First batch failed: ${r1.error}`);

    const r2 = runSddTools(['phase', 'add-batch', '--descriptions', '["Wave-Two-A","Wave-Two-B"]'], tmpDir);
  ...
  test('each phase directory contains a .gitkeep file', () => {
    const result = runSddTools(['phase', 'add-batch', '--descriptions', '["Setup","Build"]'], tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('returns error for empty descriptions array', () => {
    const result = runSddTools(['phase', 'add-batch', '--descriptions', '[]'], tmpDir);
    assert.ok(!result.success, 'should fail on empty array');
  });

  test('returns error when --descriptions JSON is not an array', () => {
    const result = runSddTools(['phase', 'add-batch', '--descriptions', '{"one":"Alpha"}'], tmpDir);
  ...
  test('returns error when --descriptions is missing its JSON value', () => {
    const missing = runSddTools(['phase', 'add-batch', '--descriptions'], tmpDir);
    ...
    const flagValue = runSddTools(['phase', 'add-batch', '--descriptions', '--raw'], tmpDir);
...
`
    ...
    const result = runSddTools('phase insert 1 Fix Critical Bug', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runSddTools('phase insert 1 Another Fix', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects missing phase', () => {
    ...
    const result = runSddTools('phase insert 99 Fix Something', tmpDir);
...
`
    ...
    const result = runSddTools('phase insert 9.05 Padding Test', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    // Remove phase 2
    const result = runSddTools('phase remove 2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('rejects removal of phase with summaries unless --force', () => {
    ...
    const result = runSddTools('phase remove 1', tmpDir);
    ...
    const forceResult = runSddTools('phase remove 1 --force', tmpDir);
  ...
  test('bug-3409: supports --force before phase id', () => {
    ...
    const result = runSddTools('phase remove --force 2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('removes decimal phase and renumbers siblings', () => {
    ...
    const result = runSddTools('phase remove 6.2', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('updates STATE.md phase count', () => {
    ...
    runSddTools('phase remove 2', tmpDir);
...
`
  ...
  test('bug-3355: integer phase remove renumbers roadmap once without collapsing later phases', () => {
    ...
    const result = runSddTools('phase remove 27 --force', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runSddTools('phase complete 1', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runSddTools('phase complete 03.2.1', tmpDir);
...
const { comparePhaseNum, normalizePhaseName } = require('../sdd/bin/lib/core.cjs');
...
describe('phase complete milestone-scoped next-phase', () => {
  ...
  test('finds next phase within milestone, ignoring prior milestone dirs', () => {
    ...
    const result = runSddTools('phase complete 5', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('phase resolution uses exact token matching', () => {
  ...
  test('1009 must NOT match 1009A-feature-consistency when 1009 dir is absent', () => {
    ...
    const result = runSddTools('find-phase 1009', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
    const output = JSON.parse(result.output);
  ...
  test('999.6 must NOT match 999.60-episode-processing when 999.6 dir is absent', () => {
    ...
    const result = runSddTools('find-phase 999.6', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
    const output = JSON.parse(result.output);
  ...
  test('normal non-colliding phases still resolve', () => {
    ...
    const r1 = runSddTools('find-phase 1', tmpDir);
    ...
    const r2 = runSddTools('find-phase 2', tmpDir);
...
describe('phase complete updates Performance Metrics', () => {
  ...
  test('after cmdPhaseComplete: Performance Metrics has updated total plans count', () => {
    ...
    const result = runSddTools('phase complete 2', tmpDir);
