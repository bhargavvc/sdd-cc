...
// The commands/sdd/*.md and sdd/workflows/*.md files are the
...
describe('skill frontmatter: /sdd-plan-phase --research-phase flag absorbs the standalone research command', () => {
