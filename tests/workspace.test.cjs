...
describe('workspace command files', () => {
  ...
  test('new-workspace command exists with correct frontmatter', () => {
    const content = fs.readFileSync(path.join(baseDir, 'commands/sdd/new-workspace.md'), 'utf8');
    assert.ok(content.includes('name: sdd:new-workspace'));
  ...
  test('list-workspaces command exists with correct frontmatter', () => {
    const content = fs.readFileSync(path.join(baseDir, 'commands/sdd/list-workspaces.md'), 'utf8');
    assert.ok(content.includes('name: sdd:list-workspaces'));
    assert.ok(content.includes('workflows/list-workspaces.md'));
  });

  test('remove-workspace command exists with correct frontmatter', () => {
    const content = fs.readFileSync(path.join(baseDir, 'commands/sdd/remove-workspace.md'), 'utf8');
    assert.ok(content.includes('name: sdd:remove-workspace'));
...
describe('workspace routing in sdd-tools', () => {
  test('init new-workspace is routed correctly', () => {
    const toolsContent = fs.readFileSync(
      path.join(__dirname, '..', 'sdd', 'bin', 'sdd-tools.cjs'),
      'utf8'
    );
