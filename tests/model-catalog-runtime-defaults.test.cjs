...
const { catalog, KNOWN_RUNTIMES } = require('../sdd/bin/lib/model-catalog.cjs');

const ROOT = path.join(__dirname, '..');
const SETTINGS_ADVANCED = fs.readFileSync(path.join(ROOT, 'sdd', 'workflows', 'settings-advanced.md'), 'utf8');
