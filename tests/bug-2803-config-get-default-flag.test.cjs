 ...
 *
 * `sdd-sdk query config-get <key> --default <value>` silently ignored the
 ...
 *
 * The CJS path (sdd-tools.cjs config-get <key> --default <value>) honored
...
/**
 * Invoke `sdd-sdk query config-get <...args>` against a project dir.
...
describe('bug-2803: config-get --default flag honored in SDK', () => {
  ...
  beforeEach(() => {
    tmpDir = createTempProject('sdd-test-2803-');
  });
