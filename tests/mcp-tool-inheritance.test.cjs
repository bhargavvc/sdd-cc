...
describe('MCP tool usage in SDD agents', () => {
  const agentFiles = [
    path.join(__dirname, '..', 'agents', 'sdd-executor.md'),
    path.join(__dirname, '..', 'agents', 'sdd-planner.md'),
  ];
  ...
  test('sdd-executor.md explicitly instructs to use available MCP tools', () => {
