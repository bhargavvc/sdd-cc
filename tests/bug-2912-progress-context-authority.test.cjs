/**
 * Tests for issue #2912 — /sdd-progress can use stale CLAUDE.md project block
 * instead of SDD tracking files as authoritative source.
 *
 * Fix: the `report` step in sdd/workflows/progress.md must contain
