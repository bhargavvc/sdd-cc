 ...
 *
 * After #3042 deleted /sdd-research-phase (replaced by
 * /sdd-plan-phase --research-phase <N>) and v1.40.0 consolidated /sdd-insert-phase
 * into /sdd-phase insert, six occurrences survived in agents/*.md because none of
 ...
 * runs the /sdd- → /sdd: namespace transform, not retired-name replacement.
 *
