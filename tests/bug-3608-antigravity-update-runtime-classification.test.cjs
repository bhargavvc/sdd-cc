...
// update.md is loaded verbatim by the runtime as the /sdd-update workflow.
...
/**
 * Bug #3608: sdd/workflows/update.md does not model Antigravity as
 * a first-class runtime, so /sdd-update invoked from an Antigravity install
 ...
 * agree, or /sdd-update routes Antigravity installs through the base Gemini
 * path.
 *
...
const UPDATE_MD = path.join(__dirname, '..', 'sdd', 'workflows', 'update.md');
