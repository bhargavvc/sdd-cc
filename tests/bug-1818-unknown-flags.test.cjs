 ...
 *
 * Original #1818 invariant: sdd-tools must NOT silently ignore --help/-h
 ...
 * subcommand discoverability for `sdd-sdk query <subcommand> --help`.
 *
 ...
 *
 * --version remains rejected — it's never a valid sdd-tools flag and has
...
const { runSddTools, createTempProject, cleanup, isUsageOutput } = require('./helpers.cjs');
