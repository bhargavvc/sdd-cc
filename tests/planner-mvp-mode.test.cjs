/**
 * sdd-planner agent — MVP-mode branch contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'sdd-planner.md');
const REF_MVP = path.join(__dirname, '..', 'sdd', 'references', 'planner-mvp-mode.md');
const REF_SKEL = path.join(__dirname, '..', 'sdd', 'references', 'skeleton-template.md');

describe('sdd-planner — MVP-mode branch', () => {
