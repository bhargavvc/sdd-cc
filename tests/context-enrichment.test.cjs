/**
 * SDD Tools Tests - Adaptive Context Enrichment for 1M Models
 *
...
describe('execute-phase.md context enrichment', () => {
  const EXECUTE_WORKFLOW_PATH = path.join(__dirname, '..', 'sdd', 'workflows', 'execute-phase.md');
...
describe('plan-phase.md context enrichment', () => {
  const PLAN_WORKFLOW_PATH = path.join(__dirname, '..', 'sdd', 'workflows', 'plan-phase.md');
