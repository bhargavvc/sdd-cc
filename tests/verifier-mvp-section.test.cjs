/**
 * sdd-verifier agent — MVP Mode Verification section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'sdd-verifier.md');
const REF = path.join(__dirname, '..', 'sdd', 'references', 'verify-mvp-mode.md');
...
describe('sdd-verifier — MVP Mode Verification section', () => {
