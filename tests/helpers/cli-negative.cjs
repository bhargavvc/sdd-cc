 ...
 *
 * Wraps spawnSync of sdd/bin/sdd-tools.cjs so test files can
...
const TOOLS_PATH = path.resolve(__dirname, '..', '..', 'sdd', 'bin', 'sdd-tools.cjs');

/**
 * Run sdd-tools with the given argv against a project directory.
 *
 * @param {string[]} argv - argument vector passed to sdd-tools.cjs. Each
