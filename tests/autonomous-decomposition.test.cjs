...
const AUTONOMOUS_PATH = path.join(PROJECT_ROOT, 'sdd', 'workflows', 'autonomous.md');
const SMART_DISCUSS_REF = path.join(PROJECT_ROOT, 'sdd', 'references', 'autonomous-smart-discuss.md');
