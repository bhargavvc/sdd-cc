...
/**
 * SDD Tools Tests - discuss-phase power user mode
 *
...
describe('discuss-phase power user mode (#1513)', () => {
  const commandPath = path.join(__dirname, '..', 'commands', 'sdd', 'discuss-phase.md');
  const workflowPath = path.join(__dirname, '..', 'sdd', 'workflows', 'discuss-phase.md');
  const powerWorkflowPath = path.join(__dirname, '..', 'sdd', 'workflows', 'discuss-phase-power.md');
  ...
  describe('command file (discuss-phase.md)', () => {
    test('mentions --power flag in argument-hint or description', () => {
      ...
      assert.ok(
        ...
        'commands/sdd/discuss-phase.md should document the --power flag'
      );
    });
  ...
  describe('main workflow file (discuss-phase.md)', () => {
    test('has power_user_mode section or references discuss-phase-power.md', () => {
      ...
      const powerModePath = path.join(__dirname, '..', 'sdd', 'workflows', 'discuss-phase', 'modes', 'power.md');
  ...
  describe('power workflow file (discuss-phase-power.md)', () => {
    test('file exists', () => {
      assert.ok(
        ...
        'sdd/workflows/discuss-phase-power.md should exist'
      );
    });
