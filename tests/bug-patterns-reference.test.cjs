...
const REFERENCE_PATH = path.join(
  __dirname, '..', 'sdd', 'references', 'common-bug-patterns.md'
);
const DEBUGGER_AGENT_PATH = path.join(
  __dirname, '..', 'agents', 'sdd-debugger.md'
);
...
describe('debugger agent references bug patterns', () => {
  ...
  test('sdd-debugger.md references common-bug-patterns.md', () => {
