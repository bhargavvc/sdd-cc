/**
 * sdd-executor agent — MVP+TDD gate section contract
...
const AGENT = path.join(__dirname, '..', 'agents', 'sdd-executor.md');
const REF = path.join(__dirname, '..', 'sdd', 'references', 'execute-mvp-tdd.md');

describe('sdd-executor — MVP+TDD gate section', () => {
