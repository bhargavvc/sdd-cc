 ...
 * body in a single atomic write. Prior to the fix, the `/sdd:new-milestone`
...
describe('state milestone-switch (#2630)', () => {
  ...
  test('rejects missing --milestone', () => {
    ...
    // sdd-tools emits JSON with { error: ... } to stdout even on error paths.
