/**
 * Tests for sdd-check-update-worker.js — Windows npm resolution platform gate.
 *
 ...
 * targets `.cjs` files in bin/lib/sdd — `hooks/*.js` is out of
...
describe('sdd-check-update-worker: Windows npm spawn platform gate', () => {
