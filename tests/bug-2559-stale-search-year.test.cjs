 ...
 *
 * The sdd-phase-researcher and sdd-project-researcher agents instruct
...
const PHASE_RESEARCHER = path.join(
  ...
  '..',
  'agents',
  'sdd-phase-researcher.md'
);
const PROJECT_RESEARCHER = path.join(
  __dirname,
  '..',
  'agents',
  'sdd-project-researcher.md'
);

const FILES = [
  { label: 'sdd-phase-researcher.md', path: PHASE_RESEARCHER },
  { label: 'sdd-project-researcher.md', path: PROJECT_RESEARCHER },
];
