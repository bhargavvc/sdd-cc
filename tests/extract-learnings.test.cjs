...
const COMMAND_PATH = path.join(__dirname, '..', 'commands', 'sdd', 'extract-learnings.md');
const WORKFLOW_PATH = path.join(__dirname, '..', 'sdd', 'workflows', 'extract-learnings.md');

describe('extract-learnings command', () => {
  test('command file exists', () => {
    assert.ok(fs.existsSync(COMMAND_PATH), 'commands/sdd/extract-learnings.md should exist');
  });
