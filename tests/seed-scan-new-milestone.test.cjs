/**
 * SDD Tools Tests - Seed Scan in New Milestone (#2169)
 *
...
const NEW_MILESTONE_PATH = path.join(ROOT, 'sdd', 'workflows', 'new-milestone.md');
const PLANT_SEED_PATH = path.join(ROOT, 'sdd', 'workflows', 'plant-seed.md');
