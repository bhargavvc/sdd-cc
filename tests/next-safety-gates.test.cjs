...
/**
 * SDD Tools Tests - /sdd-next safety gates and prior-phase completeness scan
 *
...
describe('/sdd-next safety gates (#1732, #2089)', () => {
  const workflowPath = path.join(__dirname, '..', 'sdd', 'workflows', 'next.md');
  // #2790: next.md command was consolidated into progress.md as the --next flag.
  const commandPath = path.join(__dirname, '..', 'commands', 'sdd', 'progress.md');
  ...
  test('command definition documents --next flag with --force AND completeness routing (#2790)', () => {
    // #2790 absorbed standalone /sdd-next into /sdd-progress --next. The
