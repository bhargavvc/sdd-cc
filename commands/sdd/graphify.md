...
```
PREFLIGHT=$(node "$HOME/.claude/sdd/bin/sdd-tools.cjs" graphify build)
```
...
```
SDD > Spawning graphify-builder agent...
```
...
4. DO NOT use sdd-tools config get-value for the config gate -- it exits on missing keys
