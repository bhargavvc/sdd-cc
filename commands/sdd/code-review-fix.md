...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `sdd-sdk query init.phase-op` and delegated to agent via config blocks.
</context>
