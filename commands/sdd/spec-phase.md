...
<execution_context>
@~/.claude/sdd/workflows/spec-phase.md
@~/.claude/sdd/templates/spec.md
</execution_context>
...
<process>
Execute the spec-phase workflow from @~/.claude/sdd/workflows/spec-phase.md end-to-end.
...
- User knows they can now run /sdd-discuss-phase which will load SPEC.md automatically
</success_criteria>
