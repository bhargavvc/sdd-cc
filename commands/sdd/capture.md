...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the SDD system.
...
@~/.claude/sdd/workflows/add-backlog.md
@~/.claude/sdd/workflows/plant-seed.md
@~/.claude/sdd/workflows/check-todos.md
