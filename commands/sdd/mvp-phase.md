...
The phase must already exist in ROADMAP.md (created via `/sdd new-project`, `/sdd add-phase`, or `/sdd insert-phase`). This command does not create new phases — it converts an existing phase to MVP mode.
</context>

<process>
Execute the mvp-phase workflow from @~/.claude/sdd/workflows/mvp-phase.md end-to-end.
