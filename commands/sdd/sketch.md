...
integrate with SDD commit patterns, state tracking, and handoff workflows. Loads spike
...
Does not require `/sdd-new-project` — auto-creates `.planning/sketches/` if needed.
</objective>
...
@~/.claude/sdd/references/sketch-tooling.md
@~/.claude/sdd/references/sketch-variant-patterns.md
</execution_context>
